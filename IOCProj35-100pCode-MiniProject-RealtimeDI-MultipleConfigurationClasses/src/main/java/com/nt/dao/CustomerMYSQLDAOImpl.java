...
@Repository("cusDAO-mysql")
public class CustomerMYSQLDAOImpl implements ICustomerDAO {
	public static final String CUSTOMER_INFO_INSERT_QUERY="INSERT INTO spring_customer_info2(CNAME,CADD,BILLAMOUNT,DISCOUNT,FINALAMOUNT) VALUES(?,?,?,?,?)";
 	@Autowired
